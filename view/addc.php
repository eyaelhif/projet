    ...
    <div class="wrapper">
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                ...
                <li
                  ...
                  <li
                   class="active"
                   >
                    <a class="sidenav-item-link" href="addp.php">
      ...
      <div class="page-wrapper">
        ...
        <div class="content-wrapper">
          <div class="content">
          <form  class="user needs-validation" method="POST"  action="verifaddc.php" enctype="multipart/form-data" onsubmit="return validateText(document.getElementById('inputText').value);">
                        <div class="form-group row">
                            ...
                            <label for="champ_texte">Category Name :</label>
                                <input type="text" style="border-radius:32px;" class="form-control form-control-user"  name="type"
                                    placeholder="Category" id="inputText">
                            </div>
                        </div>
                        <div class="form-group">
                        <label>Sexe :</label>
                                <select type="number" id="choix" class="form-control" style="border-radius:32px;" name="genre" >
                        ...
                        <input class="btn btn-primary btn-user btn-block" style="border-radius:32px;" type="submit" value="Add Category">
...
(function () {
  ...
  Array.prototype.slice.call(forms)
    ...
    function validateForm() {
        ...
        const pattern = /^[A-Za-z\s]+$/; // Accepte uniquement des lettres et des espaces

        if (!pattern.test(inputText)) {
            alert("Le champ 'Category Name' ne doit contenir que des lettres et des espaces.");
