      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <a type="button" href="sortpa.php" class="mb-1 btn btn-primary">
                   <i class=" mdi mdi-arrow-top-right-thick"></i>
                          tri 
                  </a>
 
                  <a type="button" href="sortpd.php" class="mb-1 btn btn-info">
                       <i class=" mdi mdi-arrow-bottom-right-thick"></i>
                         tri
  </a>
                <!-- search form -->
                  ...
                  <div class="col-12">
                    ...
                    foreach ($list as $produit) {
                        ?>  
                            <tr>
                              <td class="py-0">
                                <img src="<?= $produit['img']; ?>" alt="Product Image">
                              </td>
                              <td><?= $produit['idp']; ?></td>
                              <td><?= $produit['nom']; ?></td>
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <a type="button" href="deletep.php?idp=<?php echo $produit['idp'];?>" style="width: 60px; height: 40px;" class="mb-1 btn btn-danger">
                                         <i class=" mdi mdi-delete-sweep"></i>
                    </a>
                    <a type="button" href="updatep.php?idp=<?php echo $produit['idp'];?>" class="mb-1 btn btn-info" style="width: 60px; height: 40px;">
