...
$categorie = $categoriep->affichercategorie($_GET['idc']);
?>
<!DOCTYPE html>
    ...
    <div class="wrapper">
      ...
      <div class="page-wrapper">
        ...
        <div class="content-wrapper">
          <div class="content">
          <form  class="user needs-validation" method="POST"  action="verifupdatec.php" enctype="multipart/form-data" onsubmit="return validateText(document.getElementById('inputText').value);">
          <div>
          <label>Identification: </label>
          <h2><span class="badge badge-pill badge-info"><?php echo $categorie['idc']?></span></h2>  
  </div>   
          <div class="form-group row">
                        
                            <div class="col-sm-6 mb-3 mb-sm-0">
                            <label for="champ_texte">Category Name :</label>
                                <input type="text" style="border-radius:32px;" class="form-control form-control-user"  name="type"
                                    placeholder="<?php echo $categorie['type']?>" id="inputText" >
                                    <input type="number" style="border-radius:32px;" class="form-control form-control-user"  name="idc"
                                    value="<?php echo $_GET['idc']?>" id="inputText" hidden>
                            </div>
                        </div>
                        <div class="form-group">
                        <label>Sexe :</label>
                                <select type="number" id="choix" class="form-control" placeholder="<?php echo $categorie['genre']?>" style="border-radius:32px;" name="genre" >
                        ...
                        <input class="btn btn-primary btn-user btn-block" style="border-radius:32px;" type="submit" value="Update Category">
