    ...
    <div class="wrapper">
      ...
      <div class="page-wrapper">
        ...
        <div class="content-wrapper">
          <div class="content">
          <form  class="user needs-validation" method="POST"  action="verifupdatep.php" enctype="multipart/form-data" onsubmit="return validateText(document.getElementById('inputText').value);">
          <div class="form-group">
          <label>Identification: </label>
          <h2><span class="badge badge-pill badge-info"><?php echo $_GET['idp']?></span></h2>
                        </div>
          <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                            <label for="champ_texte">Product Name :</label>
                                <input type="text" style="border-radius:32px;" class="form-control form-control-user"  name="nom"
                                    placeholder="<?php echo $produit['nom']?>" id="inputText">
                            </div>
                            <div class="col-sm-6">
                           <!-- <label>Image: </label>
                            <div>
                                <input type="file" class="btn btn-primary btn-user btn-block" style="border-radius:32px;" name="img"  />
                            </div>-->
                            <div class="col-sm-6">
    <label>Image:</label>
    <div>
        <input type="file" class="btn btn-primary btn-user btn-block" style="border-radius: 32px;" name="img" id="imgInput" onchange="updateImage()" />
    </div>
    <img id="previewImage" src="<?php echo $produit['img']?>" alt="Current Image">
</div>
...
<script>
    ...
    function updateImage() {
        ...
        if (input.files && input.files[0]) {
            ...
            preview.src ="<?php echo $produit['img'] ?>";
        }
    }
</script>
                        ...
                        <div class="form-group">
                        <label>Price :</label>
                            <input type="number" class="form-control form-control-user" style="border-radius:32px;"name="prix"
                                placeholder="<?php echo $produit['prix']?>" onkeyup="verifNombre(this)" >
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                            <label>Number :</label>
                                <input type="number" class="form-control form-control-user" style="border-radius:32px;"
                                    name="nombre" placeholder="<?php echo $produit['nombre']?>" onblur="verifNombre(this)" >
                            </div>
                            <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                            
                                <input type="number" class="form-control form-control-user" style="border-radius:32px;"
                                    name="idc" value="<?php echo $produit['idc']?>" onblur="verifNombre(this)" hidden>
                            </div>
                            
                        </div></div>
                        
                 
                        <input class="btn btn-primary btn-user btn-block" style="border-radius:32px;" type="submit" value="Add Product">
