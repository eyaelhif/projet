    ...
    <div class="wrapper">
      ...
      <div class="page-wrapper">
        ...
        <div class="content-wrapper">
          <div class="content">
          <form  class="user needs-validation" method="POST"  action="verifaddp.php" enctype="multipart/form-data" onsubmit="return validateText(document.getElementById('inputText').value);">
          <div class="form-group">
          <h2><span class="badge badge-pill badge-info"><?php echo $_GET['type']?></span></h2>
                        </div>
          <div class="form-group row">
                        ...
                        <label>Price :</label>
                            <input type="number" class="form-control form-control-user" style="border-radius:32px;"name="prix"
                                placeholder="Prix" onkeyup="verifNombre(this)" >
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                            <label>Number :</label>
                                <input type="number" class="form-control form-control-user" style="border-radius:32px;"
                                    name="nombre" placeholder="Nombre" onblur="verifNombre(this)" >
                            </div>
                            <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                            
                                <input type="number" class="form-control form-control-user" style="border-radius:32px;"
                                    name="idc" value="<?php echo $_GET['idc']?>" onblur="verifNombre(this)" hidden>
                            </div>
